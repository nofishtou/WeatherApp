...
//   xhr.open('GET', `https://api.openweathermap.org/data/2.5/weather?id=${townId}&units=metric&appid=237d46de088807b8ea4371af72fb7dbd`, true);
...
//     icon.innerHTML =`<img src="https://openweathermap.org/img/wn/${url}@2x.png" alt="" srcset="" width="20px" height="20px"/>`
//   }
